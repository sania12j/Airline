...
const transportMail = router.get("/", async (req, res) => {
  ...
  const info = await transporter
    .sendMail({
      ...
      subject: "Your Flight has Been Postponed !", // Subject line
      text: "Hello world? NOWW", // plain text body
      html: "<h2>Sorry! Your ticket has been Postponed due to cancel of Booking</h2><img src='https://th.bing.com/th/id/OIP.n1YM6D2bByLFvmSYqst0DQAAAA?pid=ImgDet&w=168.75&h=180&c=7&dpr=1.3' alt='Image description'>", // html body
    })
    .catch(console.error);
